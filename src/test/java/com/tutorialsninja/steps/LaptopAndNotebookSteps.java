...
import com.tutorialsninja.pages.LaptopAndBooksPage;
...
public class LaptopAndNotebookSteps {
    ...
    public void iFillAllMandatoryFields() {
        new CheckOutPage().fillAllMandatoryField("Michel", "Jackson", "mkjk@gmail.com", "0987654321",
                "Bhavnath", "Junagadh", "3456789", "India", "Gujarat");
    }
