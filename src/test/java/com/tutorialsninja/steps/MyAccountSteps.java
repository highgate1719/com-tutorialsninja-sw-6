...
public class MyAccountSteps {
    ...
    public void iEnterTelephone() {
        new RegisterPage().enterTelephoneNumber("1234567890");
    }

    @And("I enter password")
    public void iEnterPassword() {
        new RegisterPage().enterPassword("0987654");
    }

    @And("I enter confirm password")
    public void iEnterConfirmPassword() {
        new RegisterPage().enterConfirmPassword("0987654");
    }
    ...
    public void iEnterEmailAddress() {
        new RegisterPage().enterEmail("robert_jackson@gmail.com");
    }
